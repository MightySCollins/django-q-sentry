...
```
Please check the [python sentry client configuration docs](https://docs.sentry.io/quickstart/?platform=python) for more options. Additional key-value pairs defined in `Q_CLUSTER['error_reporter']['sentry']` are passed directly as kwargs to instantiation of [`sentry_sdk`](https://docs.sentry.io/learn/configuration/?platform=python).
